...
def save_snaps(width=0, height=0, name="snapshot", folder=".", raspi=False, device=0):
...
def main():
    ...
    parser.add_argument("--dev", default=DEVICE, type=str, help="choose the camera")
    ...
    save_snaps(width=args.dwidth, height=args.dheight, name=args.name, folder=args.folder, raspi=args.raspi, device=args.dev)
